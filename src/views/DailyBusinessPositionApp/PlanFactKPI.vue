...
<script>
  import Table1 from '@/components/DailyBusinessPositionApp/PlanFactKPI/PivotTable1';
  import Chart1 from '@/components/DailyBusinessPositionApp/PlanFactKPI/Chart1';
