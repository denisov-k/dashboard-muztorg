...
<script>
    ...
    export default {
      ...
      data() {
        return {
          isLoading: true,
          title: 'Сводка по серверу BI',
          options: {},
          data: [],
          dataURL: 'api/WHO_LOGIN/page1/table1',
          ...
          this.getData().then(data => {
            ...
            this.options = {
              columns: [
                ...
                { title: 'Имя учетной записи', field: '5.qText', sorter: 'string', formatter:"textarea", headerFilter: "input" },
