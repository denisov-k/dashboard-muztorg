    ...
    export default {
      ...
      data() {
        return {
          ...
          options: {},
          data: [],
          dataURL: 'api/E_BUGET/page1/table3',
          ...
          this.getData().then(data => {
            ...
            this.options = {
              columns: [
                ...
                { title: 'Наименование МИ', field: '4.qText', sorter: 'string', formatter:"textarea", headerFilter: "input" },
                { title: 'Группа МИ', field: '5.qText', sorter: 'string', formatter:"textarea", headerFilter: "input" },
                { title: 'Плановое количество приобретаемых МИ в 2022 г. (ед.)', field: '6.qNum', sorter: 'number', formatter:"textarea", headerFilter: "input" },
                { title: 'Плановое количество приобретаемых МИ в 2023 г. (ед.)', field: '7.qNum', sorter: 'number', formatter:"textarea", headerFilter: "input" },
                { title: 'Плановое количество приобретаемых МИ в 2024 г. (ед.)', field: '8.qNum', sorter: 'number', formatter:"textarea", headerFilter: "input" },
                { title: 'Итого: плановое количество приобретаемых МИ в 2022-2024 гг. (ед.)', field: '9.qNum', sorter: 'number', formatter:"textarea", headerFilter: "input" },
              ],
              data,
              pagination: true,
            }
